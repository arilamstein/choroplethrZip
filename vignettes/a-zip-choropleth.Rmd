...
Note that because of its size (~60MB) the `choroplethrZip` package is not hosted on CRAN. Rather, it is hosted on github [here](https://github.com/arilamstein/choroplethrZip). You can install the package by typing the installation instructions on that page.
